...
<form action="" method="POST" enctype="multipart/form-data">
    <div class="style01">
        <table class="style02">
            ...
            <td><a class="style07">جامعة بغداد كلية العلوم قسم علوم الحاسوب</a></td>
            <td><a href="upload_ar.php" class="style07">اضافة منشور</a></td>
            <td><a href="home.php" class="style07">EN</a></td>
